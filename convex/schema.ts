...
- defines the structure of the data stored in convex for the AI Podcast Assistant.
- convex provides real-time reactivity, automatic typescript types, and transactions.
...
export default defineSchema({
  projects: defineTable({
    ...
    // soft delete timestamp - allow FREE tier to count all projects ever created
