...
export default async function CtaSection() {
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 w-72 h-72 ng-teal-200 rounded-full mix-blend-overlay filter blur-3xl opacity-30 animate-float"
                ...
                <div className="rounded-3xl p-12 md:p-16">
                    ...
                    {isAuthenticated ? (
                        <Link href="/dashboard/upload">
                            <Button
                            size="lg"
                            className="bg-white text-emerald-600 hover:bg-white/90 hover-glow text-lg px-10 py-7 roudned-xl shadow-2xl font-bold"
                            >
