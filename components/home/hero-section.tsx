...
export default async function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden mesh-background">
        <div className="container mx-auto px-24 py-24 md:pb-32 md:pt-20">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-20 animate-float">
                    ...
                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold mb-8 leading-tight">
                        <span className="gradient-emerald-text">Transform</span> Your <br /> Podcast with AI
                    </h1>

                    <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                        Upload your podcast audio and get AI summaries, transcripts, social posts, key moments, and more - all in minutes.
                    </p>
                </div>
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-300 rounded-full mix-blend-multiply filter blue-3xl opacity-20 animate-float">
        </div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-teal-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
