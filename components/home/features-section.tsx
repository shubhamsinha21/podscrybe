import { FileText, type LucideIcon, Hash, MessageSquare, Sparkles, Upload, Zap, Users } from "lucide-react";
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {FEATURES.map((feature, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className="rounded-2xl gradient-emerald p-4 w-fit mb-6 group-hover:animation-pulse-emerald transition-all">
