...
export function Header() {
    ...
    return (
       <header className={
        isDashboard ? 
        "gradient-emerald sticky top-0 transition-all shadow-xl backdrop-blur-sm z-50 border-b border-l-white/10" 
        : "glass-nav sticky top-0 transition-all z-50 backdrop:blur-md border-b border-grau-200/50 shadow-sm"
       }
    >

        <div className="container mx-auto px-4 lg:x-6">
            <div className="flex items-center justify-between h-16">
                <div className="flex items-center gap-2 lg:galp-8">
                    <Link href="/"
                ...
                <div className="flex items-center gap-2 lg:ga-3">
                    {isSignedIn ? (
                        <>
                        ...
                        >
                         ...
                         >
                            ...
                            <Button className={
                                isDashboard 
                                ? "bg-white/95 text-emerald-600 hover:bg-white hover:scale-105 gap-2 shadow-lg font-semibold transition-all duration-300 border border-white/20"
                                : "gradient-emerald text-wite hover-glow hover-scale-105 gap-2 shadow-lg transition-all duration-300"
                            }
                        >
                         ...
                         >
                            <Badge className={
                                ...
                                : "gap-1.5 hidden md:flex gradient-emerald text-white border-0 x-3 py-1.5 shadow-md hover:shadow-lg transition-all duration-300"
                            }>
