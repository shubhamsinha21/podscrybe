...
export const MAX_FILE_SIZE = 1024 * 1024 * 1024; // 100 MB limit
 ...
 export const GENERATION_OUTPUTS: GenerationOutput[] = [
    {
        name: "Summary",
        icon: FileSignature,
        description: "Creating podcast summary with key insights and takeways"
    },
    {
        name: "Key moments",
        icon: Target,
    ...
    },
    {
        ...
        icon: Youtube,
        description: "Formatting clickable chapter markers for YouTube video descriptions"
    },
 ]
